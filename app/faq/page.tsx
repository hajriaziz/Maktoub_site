            ...
            <div className="bg-background rounded-3xl p-12 border border-border shadow-sm">
              ...
              <div className="space-y-8">
                ...
                <div className="group p-8 rounded-2xl border border-border hover:border-accent hover:bg-secondary transition-all duration-300">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Vous recevrez des notifications par SMS ou par e-mail de confirmation lorsque votre commande sera expédiée
                  </p>
                </div>
                ...
                <div className="group p-8 rounded-2xl border border-border hover:border-accent hover:bg-secondary transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-semibold text-foreground text-lg">Comment puis-je vérifier ma taille selon votre coupe ?</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
                    Vous pouvez nous envoyer un message privé ou nous contacter par e-mail ou par téléphone.
                  </p>
                </div>
              </div>
            </div>
