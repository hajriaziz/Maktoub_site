          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="bg-background rounded-3xl p-12 border border-border shadow-sm">
              <div className="flex items-center mb-12">
                <div className="w-14 h-14 bg-chart-3 rounded-2xl flex items-center justify-center mr-6">
                  <svg
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-2 font-light">
                    Service unifié dans toute la Tunisie
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="relative overflow-hidden rounded-2xl p-8 border border-border bg-secondary transform hover:scale-105 transition-all duration-500">
                  ...
                  <div className="flex items-center mb-6">
                    <div className="w-3 h-3 bg-chart-3 rounded-full mr-4"></div>
                    <h3 className="font-semibold text-foreground text-xl">Grand Tunis</h3>
                  </div>
                  <ul className="text-muted-foreground space-y-4 mb-6">
                    <li className="flex items-center">
                      <svg
                        className="w-5 h-5 mr-4 text-accent"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-5 border border-border">
                    <p className="text-foreground font-semibold text-lg">Livraison 24h</p>
                    <p className="text-accent font-medium">8 DT</p>
                  </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-2xl p-8 border border-border hover:bg-chart-5 transform hover:scale-105 transition-all duration-500">
                  ...
                  <div className="flex items-center mb-6">
                    <div className="w-3 h-3 bg-chart-3 rounded-full mr-4"></div>
                    <h3 className="font-semibold text-foreground text-xl">Autres Gouvernorats</h3>
                  </div>
                  <ul className="text-muted-foreground space-y-4 mb-6">
                    <li className="flex items-center">
                      <svg
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-5 border border-border">
                    <p className="text-foreground font-semibold text-lg">Livraison 24-48h</p>
                    <p className="text-accent font-medium">8 DT</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 p-6 bg-secondary rounded-2xl border border-border">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-accent font-medium">Échange sous 48h</p>
                    <p className="text-muted-foreground text-sm mt-1">
                      Profitez de notre service d'échange dans les 48h suivant la réception de votre commande.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="group p-8 rounded-2xl border border-border hover:border-accent hover:bg-secondary transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-semibold text-foreground text-lg">Échange Sous 48h</h3>
                  </div>
                ...
                <div className="group p-8 rounded-2xl border border-border hover:border-accent hover:bg-secondary transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-semibold text-foreground text-lg">Suivi en Temps Réel</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="group p-8 rounded-2xl border border-border hover:border-accent hover:bg-secondary transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-semibold text-foreground text-lg">Emballage Premium</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="group p-8 rounded-2xl border border-border hover:border-accent hover:bg-secondary transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-semibold text-foreground text-lg">Paiement en Espèces</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-background rounded-3xl p-8 border border-border shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg
                    className="w-5 h-5 text-accent mr-4 mt-0.5 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    <p className="font-medium text-foreground">Livraison Express 24h</p>
                    <p className="text-muted-foreground text-sm">Grand Tunis uniquement</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Livraison 24-48h</p>
                    <p className="text-muted-foreground text-sm">Autres gouvernorats</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Échange sous 48h</p>
                    <p className="text-muted-foreground text-sm">Avec un frais de 8dt</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-background rounded-3xl p-8 border border-border shadow-sm">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-3 border-b border-border">
                  ...
                  <span className="font-semibold text-accent">8h - 18h</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-border">
                  <span className="text-muted-foreground">Samedi</span>
                  <span className="font-semibold text-accent">8h - 16h</span>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 bg-secondary rounded-3xl p-16 border border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="text-center">
              <div className="w-20 h-20 bg-chart-3 rounded-3xl flex items-center justify-center mx-auto mb-6">
                <svg
                  className="w-10 h-10 text-foreground"
                  fill="none"
                  stroke="currentColor"
              ...
              <h3 className="font-semibold text-foreground text-lg mb-3">Rapidité</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Livraison express 24h dans Grand Tunis et 24-48h partout ailleurs
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-3">Sécurité</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Emballage premium et suivi en temps réel pour une tranquillité d'esprit
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-3">Flexibilité</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Échange sous 48h pour une satisfaction garantie
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-foreground text-lg mb-3">Support</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Équipe dédiée à votre service pour une expérience personnalisée
              </p>
            </div>
          </div>
        </div>
